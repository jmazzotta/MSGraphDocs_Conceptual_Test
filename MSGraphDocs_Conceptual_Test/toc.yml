            ...
            - name: Develop
              ...
              items:
                ...
                - name: Calendars
                  ...
                  - name: Delete appointments and cancel meetings
            ...
            - name: Web services reference
              ...
              - name: EWS reference
                ...
                - name: EWS operations
                  ...
                  - name: DeleteUserConfiguration operation
                  ...
                  - name: GetNonIndexableItemDetails operation
                    href: web-service-reference/getnonindexableitemdetails-operation.md
                  ...
                  - name: ResolveNames operation
                    href: web-service-reference/resolvenames-operation.md
                ...
                - name: EWS XML elements
                  ...
                  - name: Action (ProtectionRuleActionType)
                    href: web-service-reference/action-protectionruleactiontype.md
                  ...
                  - name: AdjacentMeetingCount
                    href: web-service-reference/adjacentmeetingcount.md
                  ...
                  - name: ApprovalDecisionTime
                    href: web-service-reference/approvaldecisiontime.md
                  ...
                  - name: Attributions (ArrayOfPersonaAttributionsType)
                    href: web-service-reference/attributions-arrayofpersonaattributionstype.md
                  ...
                  - name: BusyType
                    href: web-service-reference/busytype.md
                  - name: CalendarEvent
                  ...
                  - name: ClientExtension
                    href: web-service-reference/clientextension.md
                  ...
                  - name: ContactsFolder
                    href: web-service-reference/contactsfolder.md
                  ...
                  - name: ConversationTopic
                    href: web-service-reference/conversationtopic.md
                  ...
                  - name: CreateItem
                    href: web-service-reference/createitem.md
                  ...
                  - name: DayOfWeek (WorkingPeriod)
                    href: web-service-reference/dayofweek-workingperiod.md
                  - name: DayOfWeekIndex
                  ...
                  - name: DeleteItemResponseMessage
                    href: web-service-reference/deleteitemresponsemessage.md
                  - name: DeleteItems
                  ...
                  - name: DisconnectPhoneCallResponse
                    href: web-service-reference/disconnectphonecallresponse.md
                  ...
                  - name: EditAllowed
                    href: web-service-reference/editallowed.md
                  - name: EditItems
                  ...
                  - name: EndDate (ReminderType)
                    href: web-service-reference/enddate-remindertype.md
                  ...
                  - name: ExchangeStoreId
                    href: web-service-reference/exchangestoreid.md
                  ...
                  - name: FailedMailbox
                    href: web-service-reference/failedmailbox.md
                  ...
                  - name: FirstDayOfWeek
                    href: web-service-reference/firstdayofweek.md
                  - name: FirstHopServer
                  ...
                  - name: FreeBusyView
                    href: web-service-reference/freebusyview.md
                  ...
                  - name: GetDiscoverySearchConfigurationResponseMessage
                    href: web-service-reference/getdiscoverysearchconfigurationresponsemessage.md
                  ...
                  - name: GetNonIndexableItemDetailsResponseMessage
                    href: web-service-reference/getnonindexableitemdetailsresponsemessage.md
                  ...
                  - name: GetStreamingEventsResponseMessage
                    href: web-service-reference/getstreamingeventsresponsemessage.md
                  ...
                  - name: GlobalUniqueUnreadSenders
                    href: web-service-reference/globaluniqueunreadsenders.md
                  ...
                  - name: HasStartTimeChanged
                    href: web-service-reference/hasstarttimechanged.md
                  ...
                  - name: ImGroup
                    href: web-service-reference/imgroup.md
                  - name: ImItemList
                  ...
                  - name: InPlaceHoldIdentity
                    href: web-service-reference/inplaceholdidentity.md
                  - name: InReplyTo
                    href: web-service-reference/inreplyto.md
                  - name: InstallApp
                    href: web-service-reference/installapp.md
                  - name: InstallAppResponse
                    href: web-service-reference/installappresponse.md
                  - name: InstanceKey
                    href: web-service-reference/instancekey.md
                  - name: IntendedFreeBusyStatus
                    href: web-service-reference/intendedfreebusystatus.md
                  - name: Intent
                    href: web-service-reference/intent.md
                  - name: InternalDomains (SmtpDomainList)
                    href: web-service-reference/internaldomains-smtpdomainlist.md
                  - name: InternalId
                    href: web-service-reference/internalid.md
                  - name: InternalReply
                    href: web-service-reference/internalreply.md
                  - name: InternetMessageHeader
                    href: web-service-reference/internetmessageheader.md
                  - name: InternetMessageHeaders
                    href: web-service-reference/internetmessageheaders.md
                  - name: InternetMessageId
                    href: web-service-reference/internetmessageid.md
                  - name: Interval
                    href: web-service-reference/interval.md
                  - name: InvalidRecipient
                    href: web-service-reference/invalidrecipient.md
                  - name: InvalidRecipient (MailTips)
                    href: web-service-reference/invalidrecipient-mailtips.md
                  - name: InvalidRecipients
                    href: web-service-reference/invalidrecipients.md
                  - name: IsAllDayEvent
                    href: web-service-reference/isalldayevent.md
                  - name: IsApprovalRequest
                    href: web-service-reference/isapprovalrequest.md
                  - name: IsArchive
                    href: web-service-reference/isarchive.md
                  - name: IsAssignmentEditable
                    href: web-service-reference/isassignmenteditable.md
                  - name: IsAssociated
                    href: web-service-reference/isassociated.md
                  - name: IsAutomaticForward
                    href: web-service-reference/isautomaticforward.md
                  - name: IsAutomaticReply
                    href: web-service-reference/isautomaticreply.md
                  - name: IsCancelled
                    href: web-service-reference/iscancelled.md
                  - name: IsClutter
                    href: web-service-reference/isclutter.md
                  - name: IsComplete
                    href: web-service-reference/iscomplete.md
                  - name: IsContactPhoto
                    href: web-service-reference/iscontactphoto.md
                  - name: IsDebug
                    href: web-service-reference/isdebug.md
                  - name: IsDelegated
                    href: web-service-reference/isdelegated.md
                  - name: IsDeliveryReceiptRequested
                    href: web-service-reference/isdeliveryreceiptrequested.md
                  - name: IsDraft
                    href: web-service-reference/isdraft.md
                  - name: IsEnabled
                    href: web-service-reference/isenabled.md
                  - name: IsEncrypted
                    href: web-service-reference/isencrypted.md
                  - name: IsEqualTo
                    href: web-service-reference/isequalto.md
                  - name: IsException
                    href: web-service-reference/isexception.md
                  - name: IsExternalMailbox
                    href: web-service-reference/isexternalmailbox.md
                  - name: IsFolderContact
                    href: web-service-reference/isfoldercontact.md
                  - name: IsFolderOwner
                    href: web-service-reference/isfolderowner.md
                  - name: IsFolderVisible
                    href: web-service-reference/isfoldervisible.md
                  - name: IsFromMe
                    href: web-service-reference/isfromme.md
                  - name: IsGreaterThan
                    href: web-service-reference/isgreaterthan.md
                  - name: IsGreaterThanOrEqualTo
                    href: web-service-reference/isgreaterthanorequalto.md
                  - name: IsHidden
                    href: web-service-reference/ishidden.md
                  - name: IsInError
                    href: web-service-reference/isinerror.md
                  - name: IsInline
                    href: web-service-reference/isinline.md
                  - name: IsLessThan
                    href: web-service-reference/islessthan.md
                  - name: IsLessThanOrEqualTo
                    href: web-service-reference/islessthanorequalto.md
                  - name: IsManagedFoldersRoot
                    href: web-service-reference/ismanagedfoldersroot.md
                  - name: IsMeeting
                    href: web-service-reference/ismeeting.md
                  - name: IsMeeting (CalendarEventDetails)
                    href: web-service-reference/ismeeting-calendareventdetails.md
                  - name: IsMeetingRequest
                    href: web-service-reference/ismeetingrequest.md
                  - name: IsMeetingResponse
                    href: web-service-reference/ismeetingresponse.md
                  - name: IsMember
                    href: web-service-reference/ismember.md
                  - name: IsMember (FederatedDirectoryGroupType)
                    href: web-service-reference/ismember-federateddirectorygrouptype.md
                  - name: IsMembershipGroup
                    href: web-service-reference/ismembershipgroup.md
                  - name: IsModerated
                    href: web-service-reference/ismoderated.md
                  - name: IsNDR
                    href: web-service-reference/isndr.md
                  - name: IsNotEqualTo
                    href: web-service-reference/isnotequalto.md
                  - name: IsNotSupported
                    href: web-service-reference/isnotsupported.md
                  - name: IsOccurrencePresent
                    href: web-service-reference/isoccurrencepresent.md
                  - name: IsOnlineMeeting
                    href: web-service-reference/isonlinemeeting.md
                  - name: IsOrganizer
                    href: web-service-reference/isorganizer.md
                  - name: IsOutOfDate
                    href: web-service-reference/isoutofdate.md
                  - name: IsOwner
                    href: web-service-reference/isowner.md
                  - name: IsPartiallyIndexed
                    href: web-service-reference/ispartiallyindexed.md
                  - name: IsPermanentFailure
                    href: web-service-reference/ispermanentfailure.md
                  - name: IsPermissionControlled
                    href: web-service-reference/ispermissioncontrolled.md
                  - name: IsPin
                    href: web-service-reference/ispin.md
                  - name: IsPinned (FederatedDirectoryGroupType)
                    href: web-service-reference/ispinned-federateddirectorygrouptype.md
                  - name: IsPrivate
                    href: web-service-reference/isprivate.md
                  - name: IsQuickContact
                    href: web-service-reference/isquickcontact.md
                  - name: IsRead
                    href: web-service-reference/isread.md
                  - name: IsReadReceipt
                    href: web-service-reference/isreadreceipt.md
                  - name: IsReadReceiptRequested
                    href: web-service-reference/isreadreceiptrequested.md
                  - name: IsRecurring
                    href: web-service-reference/isrecurring.md
                  - name: IsRecurring (CalendarEventDetails)
                    href: web-service-reference/isrecurring-calendareventdetails.md
                  - name: IsReminderSet
                    href: web-service-reference/isreminderset.md
                  - name: IsResend
                    href: web-service-reference/isresend.md
                  - name: IsResponseRequested
                    href: web-service-reference/isresponserequested.md
                  - name: IsSigned
                    href: web-service-reference/issigned.md
                  - name: IsSubmitted
                    href: web-service-reference/issubmitted.md
                  - name: IsTeamTask
                    href: web-service-reference/isteamtask.md
                  - name: IsTranscriptionEnabledInMailboxConfig
                    href: web-service-reference/istranscriptionenabledinmailboxconfig.md
                  - name: IsUndecidedApprovalRequest
                    href: web-service-reference/isundecidedapprovalrequest.md
                  - name: IsUnmodified
                    href: web-service-reference/isunmodified.md
                  - name: IsVisible
                    href: web-service-reference/isvisible.md
                  - name: IsVoicemail
                    href: web-service-reference/isvoicemail.md
                  - name: IsWorkTime
                    href: web-service-reference/isworktime.md
                  - name: IsWritable
                    href: web-service-reference/iswritable.md
                  - name: Item
                    href: web-service-reference/item.md
                  - name: Item (UploadItemType)
                    href: web-service-reference/item-uploaditemtype.md
                  - name: ItemAttachment
                    href: web-service-reference/itemattachment.md
                  - name: ItemChange
                    href: web-service-reference/itemchange.md
                  - name: ItemChanges
                    href: web-service-reference/itemchanges.md
                  - name: ItemClass
                    href: web-service-reference/itemclass.md
                  - name: ItemClasses
                    href: web-service-reference/itemclasses.md
                  - name: ItemClasses (ArrayOfItemClassType)
                    href: web-service-reference/itemclasses-arrayofitemclasstype.md
                  - name: ItemCount
                    href: web-service-reference/itemcount.md
                  - name: ItemHits
                    href: web-service-reference/itemhits.md
                  - name: ItemHoldPeriod
                    href: web-service-reference/itemholdperiod.md
                  - name: ItemId
                    href: web-service-reference/itemid.md
                  - name: ItemIds
                    href: web-service-reference/itemids.md
                  - name: ItemIds (NonEmptyArrayOfItemIdsType)
                    href: web-service-reference/itemids-nonemptyarrayofitemidstype.md
                  - name: Items
                    href: web-service-reference/items.md
                  - name: Items (ArrayOfNonIndexableItemDetailsType)
                    href: web-service-reference/items-arrayofnonindexableitemdetailstype.md
                  - name: Items (ArrayOfSearchPreviewItemsType)
                    href: web-service-reference/items-arrayofsearchpreviewitemstype.md
                  - name: Items (NonEmptyArrayOfAllItemsType)
                    href: web-service-reference/items-nonemptyarrayofallitemstype.md
                  - name: Items (NonEmptyArrayOfUploadItemsType)
                    href: web-service-reference/items-nonemptyarrayofuploaditemstype.md
                  - name: ItemShape
                    href: web-service-reference/itemshape.md
                  - name: ItemVersion
                    href: web-service-reference/itemversion.md
                  - name: JobTitle
                    href: web-service-reference/jobtitle.md
                  - name: JoinDate
                    href: web-service-reference/joindate.md
                  - name: JoinDate (FederatedDirectoryGroupType)
                    href: web-service-reference/joindate-federateddirectorygrouptype.md
                  - name: JoinedBy
                    href: web-service-reference/joinedby.md
                  - name: JoinOnlineMeetingUrl
                    href: web-service-reference/joinonlinemeetingurl.md
                  - name: JournalFolderPermissionLevel
                    href: web-service-reference/journalfolderpermissionlevel.md
                  - name: KeepProperties
                    href: web-service-reference/keepproperties.md
                  - name: Keyword
                    href: web-service-reference/keyword.md
                  - name: Keywords
                    href: web-service-reference/keywords-ex15websvcsotherref.md
                  - name: KeywordStat
                    href: web-service-reference/keywordstat.md
                  - name: KeywordStatisticsSearchResult
                    href: web-service-reference/keywordstatisticssearchresult.md
                  - name: KeywordStats
                    href: web-service-reference/keywordstats.md
                  - name: Language
                    href: web-service-reference/language.md
                  - name: Language (DiscoverySearchConfigurationType)
                    href: web-service-reference/language-discoverysearchconfigurationtype.md
                  - name: LargeAudienceCap
                    href: web-service-reference/largeaudiencecap.md
                  - name: LargeAudienceThreshold
                    href: web-service-reference/largeaudiencethreshold.md
                  - name: LastAttemptTime
                    href: web-service-reference/lastattempttime.md
                  - name: LastDeliveryTime
                    href: web-service-reference/lastdeliverytime.md
                  - name: LastModifiedName
                    href: web-service-reference/lastmodifiedname.md
                  - name: LastModifiedTime
                    href: web-service-reference/lastmodifiedtime.md
                  - name: LastName
                    href: web-service-reference/lastname.md
                  - name: LastOccurrence
                    href: web-service-reference/lastoccurrence.md
                  - name: LastResponseTime
                    href: web-service-reference/lastresponsetime.md
                  - name: Latitude
                    href: web-service-reference/latitude.md
                  - name: LegacyDN
                    href: web-service-reference/legacydn.md
                  - name: LegacyDn (FederatedDirectoryGroupType)
                    href: web-service-reference/legacydn-federateddirectorygrouptype.md
                  - name: LegacyDn (NonEmptyArrayOfLegacyDNsType)
                    href: web-service-reference/legacydn-nonemptyarrayoflegacydnstype.md
                  - name: LegacyFreeBusyStatus
                    href: web-service-reference/legacyfreebusystatus.md
                  - name: LobbyBypass
                    href: web-service-reference/lobbybypass.md
                  - name: Location
                    href: web-service-reference/location.md
                  - name: Location (CalendarEventDetails)
                    href: web-service-reference/location-calendareventdetails.md
                  - name: Location (ReminderMessageDataType)
                    href: web-service-reference/location-remindermessagedatatype.md
                  - name: LocationBasedStateDefinition
                    href: web-service-reference/locationbasedstatedefinition.md
                  - name: Locations
                    href: web-service-reference/locations.md
                  - name: LocationSource
                    href: web-service-reference/locationsource.md
                  - name: LocationUri
                    href: web-service-reference/locationuri.md
                  - name: Longitude
                    href: web-service-reference/longitude.md
                  - name: Mailbox
                    href: web-service-reference/mailbox.md
                  - name: Mailbox (string)
                    href: web-service-reference/mailbox-string.md
                  - name: Mailbox (Availability)
                    href: web-service-reference/mailbox-availability.md
                  - name: Mailbox (PreviewItemMailboxType)
                    href: web-service-reference/mailbox-previewitemmailboxtype.md
                  - name: MailboxCulture
                    href: web-service-reference/mailboxculture.md
                  - name: MailboxData
                    href: web-service-reference/mailboxdata.md
                  - name: MailboxDataArray
                    href: web-service-reference/mailboxdataarray.md
                  - name: Mailboxes (ArrayOfStringsType)
                    href: web-service-reference/mailboxes-arrayofstringstype.md
                  - name: Mailboxes (ArrayOfUserMailboxesType)
                    href: web-service-reference/mailboxes-arrayofusermailboxestype.md
                  - name: Mailboxes (NonEmptyArrayOfLegacyDNsType)
                    href: web-service-reference/mailboxes-nonemptyarrayoflegacydnstype.md
                  - name: MailboxFull
                    href: web-service-reference/mailboxfull.md
                  - name: MailboxHoldResult
                    href: web-service-reference/mailboxholdresult.md
                  - name: MailboxHoldStatus
                    href: web-service-reference/mailboxholdstatus.md
                  - name: MailboxHoldStatuses
                    href: web-service-reference/mailboxholdstatuses.md
                  - name: MailboxId
                    href: web-service-reference/mailboxid.md
                  - name: MailboxQuery
                    href: web-service-reference/mailboxquery.md
                  - name: MailboxScope
                    href: web-service-reference/mailboxscope.md
                  - name: MailboxSearchScope
                    href: web-service-reference/mailboxsearchscope.md
                  - name: MailboxSearchScopes
                    href: web-service-reference/mailboxsearchscopes.md
                  - name: MailboxSmtpAddress
                    href: web-service-reference/mailboxsmtpaddress.md
                  - name: MailboxStat
                    href: web-service-reference/mailboxstat.md
                  - name: MailboxStatisticsSearchResult
                    href: web-service-reference/mailboxstatisticssearchresult.md
                  - name: MailboxStats
                    href: web-service-reference/mailboxstats.md
                  - name: MailboxType
                    href: web-service-reference/mailboxtype.md
                  - name: MailboxType (MasterMailboxType)
                    href: web-service-reference/mailboxtype-mastermailboxtype.md
                  - name: MailTips
                    href: web-service-reference/mailtips.md
                  - name: MailTipsConfiguration (MailTipsServiceConfiguration)
                    href: web-service-reference/mailtipsconfiguration-mailtipsserviceconfiguration.md
                  - name: MailTipsEnabled
                    href: web-service-reference/mailtipsenabled.md
                  - name: MailTipsRequested
                    href: web-service-reference/mailtipsrequested.md
                  - name: MailTipsResponseMessageType
                    href: web-service-reference/mailtipsresponsemessagetype.md
                  - name: MakeItemImmutable
                    href: web-service-reference/makeitemimmutable.md
                  - name: ManagedByOrganization
                    href: web-service-reference/managedbyorganization.md
                  - name: ManagedFolderId
                    href: web-service-reference/managedfolderid.md
                  - name: ManagedFolderInformation
                    href: web-service-reference/managedfolderinformation.md
                  - name: ManagementRole
                    href: web-service-reference/managementrole.md
                  - name: Manager
                    href: web-service-reference/manager.md
                  - name: Managers
                    href: web-service-reference/managers.md
                  - name: ManagerMailbox
                    href: web-service-reference/managermailbox.md
                  - name: Manifest
                    href: web-service-reference/manifest.md
                  - name: Manifests
                    href: web-service-reference/manifests.md
                  - name: MarkAllItemsAsRead
                    href: web-service-reference/markallitemsasread.md
                  - name: MarkAllItemsAsReadResponse
                    href: web-service-reference/markallitemsasreadresponse.md
                  - name: MarkAllItemsAsReadResponseMessage
                    href: web-service-reference/markallitemsasreadresponsemessage.md
                  - name: MarkAsJunk
                    href: web-service-reference/markasjunk.md
                  - name: MarkAsJunkResponse
                    href: web-service-reference/markasjunkresponse.md
                  - name: MarkAsJunkResponseMessage
                    href: web-service-reference/markasjunkresponsemessage.md
                  - name: MarkAsRead
                    href: web-service-reference/markasread.md
                  - name: MarkImportance
                    href: web-service-reference/markimportance.md
                  - name: Master
                    href: web-service-reference/master.md
                  - name: MaxChangesReturned
                    href: web-service-reference/maxchangesreturned.md
                  - name: MaximumBodySize
                    href: web-service-reference/maximumbodysize.md
                  - name: MaximumNonWorkHourResultsByDay
                    href: web-service-reference/maximumnonworkhourresultsbyday.md
                  - name: MaximumResultsByDay
                    href: web-service-reference/maximumresultsbyday.md
                  - name: MaximumSize
                    href: web-service-reference/maximumsize.md
                  - name: MaxItems
                    href: web-service-reference/maxitems.md
                  - name: MaxItemsToReturn
                    href: web-service-reference/maxitemstoreturn.md
                  - name: MaxMessageSize
                    href: web-service-reference/maxmessagesize.md
                  - name: MaxRecipientsPerGetMailTipsRequest
                    href: web-service-reference/maxrecipientspergetmailtipsrequest.md
                  - name: MeetingCancellation
                    href: web-service-reference/meetingcancellation.md
                  - name: MeetingDurationInMinutes
                    href: web-service-reference/meetingdurationinminutes.md
                  - name: MeetingMessage
                    href: web-service-reference/meetingmessage.md
                  - name: MeetingRequest
                    href: web-service-reference/meetingrequest.md
                  - name: MeetingRequestType
                    href: web-service-reference/meetingrequesttype.md
                  - name: MeetingRequestWasSent
                    href: web-service-reference/meetingrequestwassent.md
                  - name: MeetingResponse
                    href: web-service-reference/meetingresponse.md
                  - name: MeetingString
                    href: web-service-reference/meetingstring.md
                  - name: MeetingSuggestion
                    href: web-service-reference/meetingsuggestion.md
                  - name: MeetingSuggestions
                    href: web-service-reference/meetingsuggestions.md
                  - name: MeetingTime
                    href: web-service-reference/meetingtime.md
                  - name: MeetingTimeZone
                    href: web-service-reference/meetingtimezone.md
                  - name: MeetingWorkspaceUrl
                    href: web-service-reference/meetingworkspaceurl.md
                  - name: Member
                    href: web-service-reference/member-ex15websvcsotherref.md
                  - name: Members
                    href: web-service-reference/members.md
                  - name: Members (MemberListType)
                    href: web-service-reference/members-memberlisttype.md
                  - name: MemberCorrelationKey
                    href: web-service-reference/membercorrelationkey.md
                  - name: MergedFreeBusy
                    href: web-service-reference/mergedfreebusy.md
                  - name: MergedFreeBusyIntervalInMinutes
                    href: web-service-reference/mergedfreebusyintervalinminutes.md
                  - name: Message
                    href: web-service-reference/message-ex15websvcsotherref.md
                  - name: Message (Availability)
                    href: web-service-reference/message-availability.md
                  - name: MessageClassifications
                    href: web-service-reference/messageclassifications.md
                  - name: MessageCount
                    href: web-service-reference/messagecount.md
                  - name: MessageId
                    href: web-service-reference/messageid.md
                  - name: MessageText
                    href: web-service-reference/messagetext.md
                  - name: MessageTrackingReport
                    href: web-service-reference/messagetrackingreport.md
                  - name: MessageTrackingReportId
                    href: web-service-reference/messagetrackingreportid.md
                  - name: MessageTrackingSearchResult
                    href: web-service-reference/messagetrackingsearchresult.md
                  - name: MessageTrackingSearchResults
                    href: web-service-reference/messagetrackingsearchresults.md
                  - name: MessageTypes
                    href: web-service-reference/messagetypes.md
                  - name: MessageXml
                    href: web-service-reference/messagexml.md
                  - name: Metadata
                    href: web-service-reference/metadata-ex15websvcsotherref.md
                  - name: MiddleName
                    href: web-service-reference/middlename.md
                  - name: MiddleNames
                    href: web-service-reference/middlenames.md
                  - name: Mileage
                    href: web-service-reference/mileage.md
                  - name: MimeContent
                    href: web-service-reference/mimecontent.md
                  - name: MimeContentUTF8
                    href: web-service-reference/mimecontentutf8.md
                  - name: MinimumSize
                    href: web-service-reference/minimumsize.md
                  - name: MinimumSuggestionQuality
                    href: web-service-reference/minimumsuggestionquality.md
                  - name: MobilePhones
                    href: web-service-reference/mobilephones.md
                  - name: MobilePhones2
                    href: web-service-reference/mobilephones2.md
                  - name: ModifiedEvent
                    href: web-service-reference/modifiedevent.md
                  - name: ModifiedOccurrences
                    href: web-service-reference/modifiedoccurrences.md
                  - name: Modify
                    href: web-service-reference/modify.md
                  - name: ModifyRecipientsAllowed
                    href: web-service-reference/modifyrecipientsallowed.md
                  - name: Month
                    href: web-service-reference/month.md
                  - name: Month (Time Zone Transition)
                    href: web-service-reference/month-time-zone-transition.md
                  - name: Month (Item Recurrence)
                    href: web-service-reference/month-item-recurrence.md
                  - name: MonthlyRegeneration
                    href: web-service-reference/monthlyregeneration.md
                  - name: MoreEvents
                    href: web-service-reference/moreevents.md
                  - name: MovedEvent
                    href: web-service-reference/movedevent.md
                  - name: MovedItemId
                    href: web-service-reference/moveditemid.md
                  - name: MoveFolder
                    href: web-service-reference/movefolder.md
                  - name: MoveFolderResponse
                    href: web-service-reference/movefolderresponse.md
                  - name: MoveFolderResponseMessage
                    href: web-service-reference/movefolderresponsemessage.md
                  - name: MoveItem
                    href: web-service-reference/moveitem.md
                  - name: MoveItemResponse
                    href: web-service-reference/moveitemresponse.md
                  - name: MoveItemResponseMessage
                    href: web-service-reference/moveitemresponsemessage.md
                  - name: MoveToFolder
                    href: web-service-reference/movetofolder.md
                  - name: MSExchangeCertificate
                    href: web-service-reference/msexchangecertificate.md
                  - name: MustDisplayComment
                    href: web-service-reference/mustdisplaycomment.md
                  - name: MyResponseType
                    href: web-service-reference/myresponsetype.md
                  - name: Name (AttachmentType)
                    href: web-service-reference/name-attachmenttype.md
                  - name: Name (EmailAddressType)
                    href: web-service-reference/name-emailaddresstype.md
                  - name: Name (EmailAddress)
                    href: web-service-reference/name-emailaddress.md
                  - name: Name (ExtendedAttributeType)
                    href: web-service-reference/name-extendedattributetype.md
                  - name: Name (Message Tracking)
                    href: web-service-reference/name-message-tracking.md
                  - name: Name (string)
                    href: web-service-reference/name-string.md
                  - name: NetShowUrl
                    href: web-service-reference/netshowurl.md
                  - name: NewBodyContent
                    href: web-service-reference/newbodycontent.md
                  - name: NewDisplayName
                    href: web-service-reference/newdisplayname.md
                  - name: NewMailEvent
                    href: web-service-reference/newmailevent.md
                  - name: NewReminderTime
                    href: web-service-reference/newremindertime.md
                  - name: NextPredictedAction
                    href: web-service-reference/nextpredictedaction.md
                  - name: NextPredictedAction (ItemType)
                    href: web-service-reference/nextpredictedaction-itemtype.md
                  - name: Nickname
                    href: web-service-reference/nickname.md
                  - name: Nicknames
                    href: web-service-reference/nicknames.md
                  - name: NoEndRecurrence
                    href: web-service-reference/noendrecurrence.md
                  - name: NonIndexableItemDetail
                    href: web-service-reference/nonindexableitemdetail.md
                  - name: NonIndexableItemDetailsResult
                    href: web-service-reference/nonindexableitemdetailsresult.md
                  - name: NonIndexableItemStatistic
                    href: web-service-reference/nonindexableitemstatistic.md
                  - name: NonIndexableItemStatistics
                    href: web-service-reference/nonindexableitemstatistics.md
                  - name: NormalizedBody
                    href: web-service-reference/normalizedbody.md
                  - name: NormalizedBodyType
                    href: web-service-reference/normalizedbodytype.md
                  - name: Not
                    href: web-service-reference/not.md
                  - name: Notes (Contact)
                    href: web-service-reference/notes-contact.md
                  - name: NotesFolderPermissionLevel
                    href: web-service-reference/notesfolderpermissionlevel.md
                  - name: Notification
                    href: web-service-reference/notification-ex15websvcsotherref.md
                  - name: Notifications
                    href: web-service-reference/notifications.md
                  - name: NotSentToMe
                    href: web-service-reference/notsenttome.md
                  - name: Number
                    href: web-service-reference/number.md
                  - name: NumberedRecurrence
                    href: web-service-reference/numberedrecurrence.md
                  - name: NumberOfMembers
                    href: web-service-reference/numberofmembers.md
                  - name: NumberOfMembersAvailable
                    href: web-service-reference/numberofmembersavailable.md
                  - name: NumberOfMembersWithConflict
                    href: web-service-reference/numberofmemberswithconflict.md
                  - name: NumberOfMembersWithNoData
                    href: web-service-reference/numberofmemberswithnodata.md
                  - name: NumberOfOccurrences
                    href: web-service-reference/numberofoccurrences.md
                  - name: Occurrence
                    href: web-service-reference/occurrence.md
                  - name: Occurrence (Time Zone Transition)
                    href: web-service-reference/occurrence-time-zone-transition.md
                  - name: OccurrenceDate
                    href: web-service-reference/occurrencedate.md
                  - name: OccurrenceItemId
                    href: web-service-reference/occurrenceitemid.md
                  - name: OfficeLocation
                    href: web-service-reference/officelocation.md
                  - name: OfficeLocations
                    href: web-service-reference/officelocations.md
                  - name: Offset
                    href: web-service-reference/offset.md
                  - name: OldFolderId
                    href: web-service-reference/oldfolderid.md
                  - name: OldItemId
                    href: web-service-reference/olditemid.md
                  - name: OldParentFolderId
                    href: web-service-reference/oldparentfolderid.md
                  - name: OnlineMeetingSettings
                    href: web-service-reference/onlinemeetingsettings.md
                  - name: OofSettings
                    href: web-service-reference/oofsettings.md
                  - name: OofState
                    href: web-service-reference/oofstate.md
                  - name: OpenAsAdminOrSystemService
                    href: web-service-reference/openasadminorsystemservice.md
                  - name: Operations
                    href: web-service-reference/operations.md
                  - name: OperationIndex
                    href: web-service-reference/operationindex.md
                  - name: OptedInto
                    href: web-service-reference/optedinto.md
                  - name: OptionalAttendees
                    href: web-service-reference/optionalattendees.md
                  - name: Or
                    href: web-service-reference/or.md
                  - name: OrganizationMainPhones
                    href: web-service-reference/organizationmainphones.md
                  - name: Organizer
                    href: web-service-reference/organizer.md
                  - name: OrganizerLocation
                    href: web-service-reference/organizerlocation.md
                  - name: OriginalDisplayName
                    href: web-service-reference/originaldisplayname.md
                  - name: OriginalPhoneString
                    href: web-service-reference/originalphonestring.md
                  - name: OriginalRecipients
                    href: web-service-reference/originalrecipients.md
                  - name: OriginalStart
                    href: web-service-reference/originalstart.md
                  - name: OtherAddresses
                    href: web-service-reference/otheraddresses.md
                  - name: OtherFaxes
                    href: web-service-reference/otherfaxes.md
                  - name: OtherPhones2
                    href: web-service-reference/otherphones2.md
                  - name: OtherTelephones
                    href: web-service-reference/othertelephones.md
                  - name: OutlookRuleBlobExists
                    href: web-service-reference/outlookruleblobexists.md
                  - name: OutOfOffice
                    href: web-service-reference/outofoffice.md
                  - name: OwaLink
                    href: web-service-reference/owalink.md
                  - name: Owner
                    href: web-service-reference/owner.md
                  - name: Owners
                    href: web-service-reference/owners.md
                  - name: PageDirection
                    href: web-service-reference/pagedirection.md
                  - name: PageItemCount
                    href: web-service-reference/pageitemcount.md
                  - name: PageItemReference
                    href: web-service-reference/pageitemreference.md
                  - name: PageItemSize
                    href: web-service-reference/pageitemsize.md
                  - name: Pagers
                    href: web-service-reference/pagers.md
                  - name: PageSize
                    href: web-service-reference/pagesize.md
                  - name: ParentFolderId
                    href: web-service-reference/parentfolderid.md
                  - name: ParentFolderId (TargetFolderIdType)
                    href: web-service-reference/parentfolderid-targetfolderidtype.md
                  - name: ParentFolderIds
                    href: web-service-reference/parentfolderids.md
                  - name: ParentGroupId
                    href: web-service-reference/parentgroupid.md
                  - name: ParentId
                    href: web-service-reference/parentid.md
                  - name: ParentInternetMessageId
                    href: web-service-reference/parentinternetmessageid.md
                  - name: ParentItemId
                    href: web-service-reference/parentitemid.md
                  - name: PasswordExpirationDate
                    href: web-service-reference/passwordexpirationdate.md
                  - name: Path
                    href: web-service-reference/path.md
                  - name: PendingMailTips
                    href: web-service-reference/pendingmailtips.md
                  - name: People
                    href: web-service-reference/people.md
                  - name: PeopleUrl (FederatedDirectoryGroupType)
                    href: web-service-reference/peopleurl-federateddirectorygrouptype.md
                  - name: PercentComplete
                    href: web-service-reference/percentcomplete.md
                  - name: PerformReminderAction
                    href: web-service-reference/performreminderaction.md
                  - name: PerformReminderActionResponse
                    href: web-service-reference/performreminderactionresponse.md
                  - name: Period
                    href: web-service-reference/period.md
                  - name: Periods
                    href: web-service-reference/periods.md
                  - name: PermanentDelete
                    href: web-service-reference/permanentdelete.md
                  - name: Permission
                    href: web-service-reference/permission.md
                  - name: PermissionLevel
                    href: web-service-reference/permissionlevel.md
                  - name: Permissions
                    href: web-service-reference/permissions.md
                  - name: PermissionSet (PermissionSetType)
                    href: web-service-reference/permissionset-permissionsettype.md
                  - name: PermissionSet (CalendarPermissionSetType)
                    href: web-service-reference/permissionset-calendarpermissionsettype.md
                  - name: Persona
                    href: web-service-reference/persona.md
                  - name: PersonaId
                    href: web-service-reference/personaid.md
                  - name: PersonalHomePages
                    href: web-service-reference/personalhomepages.md
                  - name: PersonaObjectStatus
                    href: web-service-reference/personaobjectstatus.md
                  - name: Personas
                    href: web-service-reference/personas-ex15websvcsotherref.md
                  - name: PersonaShape
                    href: web-service-reference/personashape.md
                  - name: PersonaType
                    href: web-service-reference/personatype.md
                  - name: PersonName
                    href: web-service-reference/personname.md
                  - name: Phone
                    href: web-service-reference/phone.md
                  - name: Phone (PhoneEntityType)
                    href: web-service-reference/phone-phoneentitytype.md
                  - name: PhoneCallId
                    href: web-service-reference/phonecallid.md
                  - name: PhoneCallInformation
                    href: web-service-reference/phonecallinformation.md
                  - name: PhoneCallState
                    href: web-service-reference/phonecallstate.md
                  - name: PhoneNumber
                    href: web-service-reference/phonenumber.md
                  - name: PhoneNumberAttributedValue
                    href: web-service-reference/phonenumberattributedvalue.md
                  - name: PhoneNumbers
                    href: web-service-reference/phonenumbers.md
                  - name: PhoneNumbers (ArrayOfPhoneEntitiesType)
                    href: web-service-reference/phonenumbers-arrayofphoneentitiestype.md
                  - name: PhoneNumbers (ArrayOfPhonesType)
                    href: web-service-reference/phonenumbers-arrayofphonestype.md
                  - name: PhoneString
                    href: web-service-reference/phonestring.md
                  - name: PhoneticFirstName
                    href: web-service-reference/phoneticfirstname.md
                  - name: PhoneticFullName
                    href: web-service-reference/phoneticfullname.md
                  - name: PhoneticLastName
                    href: web-service-reference/phoneticlastname.md
                  - name: Photo
                    href: web-service-reference/photo.md
                  - name: Photo (MasterMailboxType)
                    href: web-service-reference/photo-mastermailboxtype.md
                  - name: PhotoUrl
                    href: web-service-reference/photourl.md
                  - name: PhotoUrl (FederatedDirectoryGroupType)
                    href: web-service-reference/photourl-federateddirectorygrouptype.md
                  - name: PhysicalAddresses
                    href: web-service-reference/physicaladdresses.md
                  - name: PictureData
                    href: web-service-reference/picturedata.md
                  - name: PlayOnPhone (Exchange web services)
                    href: web-service-reference/playonphone-exchange-web-services.md
                  - name: PlayOnPhoneDialString
                    href: web-service-reference/playonphonedialstring-exchange-web-services.md
                  - name: PlayOnPhoneEnabled
                    href: web-service-reference/playonphoneenabled.md
                  - name: PlayOnPhoneResponse (Exchange web services)
                    href: web-service-reference/playonphoneresponse-exchange-web-services.md
                  - name: PolicyNudgeRulesConfiguration
                    href: web-service-reference/policynudgerulesconfiguration.md
                  - name: PolicyTag
                    href: web-service-reference/policytag.md
                  - name: PolicyTipsEnabled
                    href: web-service-reference/policytipsenabled.md
                  - name: PortalText (EncryptionConfigurationResponseType)
                    href: web-service-reference/portaltext-encryptionconfigurationresponsetype.md
                  - name: PortalText (SetEncryptionConfigurationType)
                    href: web-service-reference/portaltext-setencryptionconfigurationtype.md
                  - name: Position
                    href: web-service-reference/position.md
                  - name: PostalAddress (PersonaPostalAddressType)
                    href: web-service-reference/postaladdress-personapostaladdresstype.md
                  - name: PostalAddressAttributedValue
                    href: web-service-reference/postaladdressattributedvalue.md
                  - name: PostalAddressIndex
                    href: web-service-reference/postaladdressindex.md
                  - name: PostalCode
                    href: web-service-reference/postalcode.md
                  - name: PostedTime
                    href: web-service-reference/postedtime.md
                  - name: PostItem
                    href: web-service-reference/postitem.md
                  - name: PostOfficeBox
                    href: web-service-reference/postofficebox.md
                  - name: PostReplyItem
                    href: web-service-reference/postreplyitem.md
                  - name: PredictedAction
                    href: web-service-reference/predictedaction.md
                  - name: PredictedActionReason
                    href: web-service-reference/predictedactionreason.md
                  - name: PredictedActionReasons
                    href: web-service-reference/predictedactionreasons.md
                  - name: Presenters
                    href: web-service-reference/presenters.md
                  - name: Preview
                    href: web-service-reference/preview-ex15websvcsotherref.md
                  - name: PreviewItemResponseShape
                    href: web-service-reference/previewitemresponseshape.md
                  - name: PreviousHopServer
                    href: web-service-reference/previoushopserver.md
                  - name: PreviousWatermark
                    href: web-service-reference/previouswatermark.md
                  - name: PrimarySmtpAddress
                    href: web-service-reference/primarysmtpaddress.md
                  - name: PrimarySmtpAddress (string)
                    href: web-service-reference/primarysmtpaddress-string.md
                  - name: PrincipalName
                    href: web-service-reference/principalname.md
                  - name: PrintAllowed
                    href: web-service-reference/printallowed.md
                  - name: Priority
                    href: web-service-reference/priority.md
                  - name: ProcessRightAway
                    href: web-service-reference/processrightaway.md
                  - name: Profession
                    href: web-service-reference/profession.md
                  - name: Professions
                    href: web-service-reference/professions.md
                  - name: ProgrammaticAccessAllowed
                    href: web-service-reference/programmaticaccessallowed.md
                  - name: Properties (ArrayOfStringsType)
                    href: web-service-reference/properties-arrayofstringstype.md
                  - name: Properties (ArrayOfTrackingPropertiesType)
                    href: web-service-reference/properties-arrayoftrackingpropertiestype.md
                  - name: ProposedEnd
                    href: web-service-reference/proposedend.md
                  - name: ProposedEnd (AttendeeType)
                    href: web-service-reference/proposedend-attendeetype.md
                  - name: ProposedEnd (MeetingRegistrationResponseObjectType)
                    href: web-service-reference/proposedend-meetingregistrationresponseobjecttype.md
                  - name: ProposedStart
                    href: web-service-reference/proposedstart.md
                  - name: ProposedStart (AttendeeType)
                    href: web-service-reference/proposedstart-attendeetype.md
                  - name: ProposedStart (MeetingRegistrationResponseObjectType)
                    href: web-service-reference/proposedstart-meetingregistrationresponseobjecttype.md
                  - name: ProposeNewTime
                    href: web-service-reference/proposenewtime.md
                  - name: ProtectionRulesConfiguration
                    href: web-service-reference/protectionrulesconfiguration.md
                  - name: ProxyPartnerToken
                    href: web-service-reference/proxypartnertoken.md
                  - name: ProxySecurityContext
                    href: web-service-reference/proxysecuritycontext.md
                  - name: ProxySuggesterSid
                    href: web-service-reference/proxysuggestersid.md
                  - name: PullSubscriptionRequest
                    href: web-service-reference/pullsubscriptionrequest.md
                  - name: PurportedSender
                    href: web-service-reference/purportedsender.md
                  - name: PushSubscriptionRequest
                    href: web-service-reference/pushsubscriptionrequest.md
                  - name: Query
                    href: web-service-reference/query.md
                  - name: QueryString (QueryStringType)
                    href: web-service-reference/querystring-querystringtype.md
                  - name: QueryString (String)
                    href: web-service-reference/querystring-string.md
                  - name: RadioPhones
                    href: web-service-reference/radiophones.md
                  - name: Range
                    href: web-service-reference/range.md
                  - name: Ranges
                    href: web-service-reference/ranges.md
                  - name: RawMasterTableXml
                    href: web-service-reference/rawmastertablexml.md
                  - name: Read
                    href: web-service-reference/read.md
                  - name: ReadFlag
                    href: web-service-reference/readflag.md
                  - name: ReadFlagChange
                    href: web-service-reference/readflagchange.md
                  - name: ReadItems (CalendarPermissionType)
                    href: web-service-reference/readitems-calendarpermissiontype.md
                  - name: ReadItems (PermissionType)
                    href: web-service-reference/readitems-permissiontype.md
                  - name: ReceiveCopiesOfMeetingMessages
                    href: web-service-reference/receivecopiesofmeetingmessages.md
                  - name: ReceivedBy
                    href: web-service-reference/receivedby.md
                  - name: ReceivedRepresenting
                    href: web-service-reference/receivedrepresenting.md
                  - name: ReceivedTime
                    href: web-service-reference/receivedtime.md
                  - name: Recipient
                    href: web-service-reference/recipient.md
                  - name: RecipientAddress
                    href: web-service-reference/recipientaddress.md
                  - name: RecipientFilter
                    href: web-service-reference/recipientfilter.md
                  - name: RecipientIs
                    href: web-service-reference/recipientis.md
                  - name: Recipients (ArrayOfRecipientsType)
                    href: web-service-reference/recipients-arrayofrecipientstype.md
                  - name: Recipients (ArrayOfSmtpAddressType)
                    href: web-service-reference/recipients-arrayofsmtpaddresstype.md
                  - name: RecipientTrackingEvent
                    href: web-service-reference/recipienttrackingevent.md
                  - name: RecipientTrackingEvents
                    href: web-service-reference/recipienttrackingevents.md
                  - name: RecognitionId
                    href: web-service-reference/recognitionid.md
                  - name: RecognitionResult
                    href: web-service-reference/recognitionresult.md
                  - name: Recurrence (RecurrenceType)
                    href: web-service-reference/recurrence-recurrencetype.md
                  - name: Recurrence (TaskRecurrenceType)
                    href: web-service-reference/recurrence-taskrecurrencetype.md
                  - name: RecurrenceId
                    href: web-service-reference/recurrenceid.md
                  - name: RecurringDateTransition
                    href: web-service-reference/recurringdatetransition.md
                  - name: RecurringDayTransition
                    href: web-service-reference/recurringdaytransition.md
                  - name: RecurringMasterItemId
                    href: web-service-reference/recurringmasteritemid.md
                  - name: RecurringMasterItemId (ItemIdType)
                    href: web-service-reference/recurringmasteritemid-itemidtype.md
                  - name: RecurringMasterItemIdRanges
                    href: web-service-reference/recurringmasteritemidranges.md
                  - name: ReferenceAttachment
                    href: web-service-reference/referenceattachment.md
                  - name: ReferenceAttachmentType complexType
                    href: web-service-reference/referenceattachmenttype-complextype-ews.md
                  - name: RedirectToRecipients
                    href: web-service-reference/redirecttorecipients.md
                  - name: ReferenceId
                    href: web-service-reference/referenceid.md
                  - name: ReferenceItemId
                    href: web-service-reference/referenceitemid.md
                  - name: References
                    href: web-service-reference/references.md
                  - name: Refiner
                    href: web-service-reference/refiner.md
                  - name: Refiners
                    href: web-service-reference/refiners.md
                  - name: RefreshSharingFolder
                    href: web-service-reference/refreshsharingfolder.md
                  - name: RefreshSharingFolderResponse
                    href: web-service-reference/refreshsharingfolderresponse.md
                  - name: RefreshSharingFolderResponseMessage
                    href: web-service-reference/refreshsharingfolderresponsemessage.md
                  - name: RelativeFolderPath
                    href: web-service-reference/relativefolderpath.md
                  - name: RelativeMonthlyRecurrence
                    href: web-service-reference/relativemonthlyrecurrence.md
                  - name: RelativeYearlyRecurrence
                    href: web-service-reference/relativeyearlyrecurrence.md
                  - name: RelevanceScore
                    href: web-service-reference/relevancescore.md
                  - name: Reminder
                    href: web-service-reference/reminder.md
                  - name: ReminderDueBy
                    href: web-service-reference/reminderdueby.md
                  - name: ReminderGroup
                    href: web-service-reference/remindergroup.md
                  - name: ReminderIsSet
                    href: web-service-reference/reminderisset.md
                  - name: ReminderItemAction
                    href: web-service-reference/reminderitemaction.md
                  - name: ReminderItemActions
                    href: web-service-reference/reminderitemactions.md
                  - name: ReminderMessageData
                    href: web-service-reference/remindermessagedata.md
                  - name: ReminderMinutesBeforeStart
                    href: web-service-reference/reminderminutesbeforestart.md
                  - name: ReminderNextTime
                    href: web-service-reference/remindernexttime.md
                  - name: Reminders
                    href: web-service-reference/reminders.md
                  - name: ReminderText
                    href: web-service-reference/remindertext.md
                  - name: ReminderTime
                    href: web-service-reference/remindertime.md
                  - name: ReminderType
                    href: web-service-reference/remindertype.md
                  - name: RemoveContactFromImList
                    href: web-service-reference/removecontactfromimlist.md
                  - name: RemoveContactFromImListResponse
                    href: web-service-reference/removecontactfromimlistresponse.md
                  - name: RemoveDelegate
                    href: web-service-reference/removedelegate.md
                  - name: RemoveDelegateResponse
                    href: web-service-reference/removedelegateresponse.md
                  - name: RemoveDistributionGroupFromImList
                    href: web-service-reference/removedistributiongroupfromimlist.md
                  - name: RemoveDistributionGroupFromImListResponse
                    href: web-service-reference/removedistributiongroupfromimlistresponse.md
                  - name: RemoveImContactFromGroup
                    href: web-service-reference/removeimcontactfromgroup.md
                  - name: RemoveImContactFromGroupResponse
                    href: web-service-reference/removeimcontactfromgroupresponse.md
                  - name: RemoveImGroup
                    href: web-service-reference/removeimgroup.md
                  - name: RemoveImGroupResponse
                    href: web-service-reference/removeimgroupresponse.md
                  - name: RemoveItem
                    href: web-service-reference/removeitem.md
                  - name: RemoveOutlookRuleBlob
                    href: web-service-reference/removeoutlookruleblob.md
                  - name: ReplyAllAllowed
                    href: web-service-reference/replyallallowed.md
                  - name: ReplyAllowed
                    href: web-service-reference/replyallowed.md
                  - name: ReplyAllToItem
                    href: web-service-reference/replyalltoitem.md
                  - name: ReplyBody
                    href: web-service-reference/replybody.md
                  - name: ReplyTo
                    href: web-service-reference/replyto.md
                  - name: ReplyToItem
                    href: web-service-reference/replytoitem.md
                  - name: ReportTemplate
                    href: web-service-reference/reporttemplate.md
                  - name: RequestedConfiguration
                    href: web-service-reference/requestedconfiguration.md
                  - name: RequestedExtensionIds
                    href: web-service-reference/requestedextensionids.md
                  - name: RequestedView
                    href: web-service-reference/requestedview.md
                  - name: RequestServerVersion
                    href: web-service-reference/requestserverversion.md
                  - name: RequestType
                    href: web-service-reference/requesttype.md
                  - name: RequiredAttendees
                    href: web-service-reference/requiredattendees.md
                  - name: Resolution
                    href: web-service-reference/resolution.md
                  - name: ResolutionSet
                    href: web-service-reference/resolutionset.md
                  - name: ResolveNames
                    href: web-service-reference/resolvenames.md
                  - name: ResolveNamesResponse
                    href: web-service-reference/resolvenamesresponse.md
                  - name: ResolveNamesResponseMessage
                    href: web-service-reference/resolvenamesresponsemessage.md
                  - name: Resources
                    href: web-service-reference/resources.md
                  - name: ResponseCode
                    href: web-service-reference/responsecode.md
                  - name: ResponseCode (InvalidRecipientResponseCodeType)
                    href: web-service-reference/responsecode-invalidrecipientresponsecodetype.md
                  - name: ResponseMessage
                    href: web-service-reference/responsemessage.md
                  - name: ResponseMessages
                    href: web-service-reference/responsemessages.md
                  - name: ResponseMessages (ArrayOfDelegateUserResponseMessageType)
                    href: web-service-reference/responsemessages-arrayofdelegateuserresponsemessagetype.md
                  - name: ResponseMessages (ArrayOfMailTipsResponseMessageType)
                    href: web-service-reference/responsemessages-arrayofmailtipsresponsemessagetype.md
                  - name: ResponseMessages (ArrayOfServiceConfigurationResponseMessageType)
                    href: web-service-reference/responsemessages-arrayofserviceconfigurationresponsemessagetype.md
                  - name: ResponseObjects
                    href: web-service-reference/responseobjects.md
                  - name: ResponseType
                    href: web-service-reference/responsetype.md
                  - name: RestrictedGroupIdentifier
                    href: web-service-reference/restrictedgroupidentifier.md
                  - name: RestrictedGroupSids
                    href: web-service-reference/restrictedgroupsids.md
                  - name: Restriction
                    href: web-service-reference/restriction.md
                  - name: ResultType
                    href: web-service-reference/resulttype.md
                  - name: RetentionAction
                    href: web-service-reference/retentionaction.md
                  - name: RetentionDate
                    href: web-service-reference/retentiondate.md
                  - name: RetentionId
                    href: web-service-reference/retentionid.md
                  - name: RetentionPeriod
                    href: web-service-reference/retentionperiod.md
                  - name: RetentionPolicyTag
                    href: web-service-reference/retentionpolicytag.md
                  - name: RetentionPolicyTagId
                    href: web-service-reference/retentionpolicytagid.md
                  - name: RetentionPolicyTags
                    href: web-service-reference/retentionpolicytags.md
                  - name: RetentionPolicyType
                    href: web-service-reference/retentionpolicytype.md
                  - name: ReturnNewItemIds
                    href: web-service-reference/returnnewitemids.md
                  - name: ReturnQueueEvents
                    href: web-service-reference/returnqueueevents.md
                  - name: RightsManagedMessageDecryptionStatus
                    href: web-service-reference/rightsmanagedmessagedecryptionstatus.md
                  - name: RightsManagementLicenseData
                    href: web-service-reference/rightsmanagementlicensedata.md
                  - name: RMSTemplateId
                    href: web-service-reference/rmstemplateid.md
                  - name: Role
                    href: web-service-reference/role.md
                  - name: Room
                    href: web-service-reference/room.md
                  - name: RoomList
                    href: web-service-reference/roomlist.md
                  - name: RoomLists
                    href: web-service-reference/roomlists.md
                  - name: Rooms
                    href: web-service-reference/rooms.md
                  - name: RootAddress
                    href: web-service-reference/rootaddress.md
                  - name: RootFolder (FindItemResponseMessage)
                    href: web-service-reference/rootfolder-finditemresponsemessage.md
                  - name: RootFolder (FindFolderResponseMessage)
                    href: web-service-reference/rootfolder-findfolderresponsemessage.md
                  - name: RootItemId
                    href: web-service-reference/rootitemid.md
                  - name: RoutingType (EmailAddressType)
                    href: web-service-reference/routingtype-emailaddresstype.md
                  - name: RoutingType (EmailAddress)
                    href: web-service-reference/routingtype-emailaddress.md
                  - name: Rule
                    href: web-service-reference/rule.md
                  - name: Rule (RuleType)
                    href: web-service-reference/rule-ruletype.md
                  - name: RuleId
                    href: web-service-reference/ruleid.md
                  - name: RuleOperationError
                    href: web-service-reference/ruleoperationerror.md
                  - name: RuleOperationErrors
                    href: web-service-reference/ruleoperationerrors.md
                  - name: 'Rules '
                    href: web-service-reference/rules-ex15websvcsotherref.md
                  - name: SavedItemFolderId
                    href: web-service-reference/saveditemfolderid.md
                  - name: SchemaVersionSupported
                    href: web-service-reference/schemaversionsupported.md
                  - name: Schools
                    href: web-service-reference/schools.md
                  - name: Scope (ClientAccessTokenRequestType)
                    href: web-service-reference/scope-clientaccesstokenrequesttype.md
                  - name: Scope (HighlightTermType)
                    href: web-service-reference/scope-highlighttermtype.md
                  - name: Scope (NonEmptyStringType)
                    href: web-service-reference/scope-nonemptystringtype.md
                  - name: SearchableMailbox
                    href: web-service-reference/searchablemailbox.md
                  - name: SearchableMailboxes
                    href: web-service-reference/searchablemailboxes.md
                  - name: SearchArchiveOnly
                    href: web-service-reference/searcharchiveonly.md
                  - name: SearchDumpster
                    href: web-service-reference/searchdumpster.md
                  - name: SearchExpression
                    href: web-service-reference/searchexpression.md
                  - name: SearchFilter
                    href: web-service-reference/searchfilter.md
                  - name: SearchFolder
                    href: web-service-reference/searchfolder.md
                  - name: SearchId
                    href: web-service-reference/searchid.md
                  - name: SearchItemKind
                    href: web-service-reference/searchitemkind.md
                  - name: SearchMailboxes
                    href: web-service-reference/searchmailboxes.md
                  - name: SearchMailboxesResponse
                    href: web-service-reference/searchmailboxesresponse.md
                  - name: SearchMailboxesResponseMessage
                    href: web-service-reference/searchmailboxesresponsemessage.md
                  - name: SearchMailboxesResult
                    href: web-service-reference/searchmailboxesresult.md
                  - name: SearchParameters
                    href: web-service-reference/searchparameters.md
                  - name: SearchPreviewItem
                    href: web-service-reference/searchpreviewitem.md
                  - name: SearchQueries
                    href: web-service-reference/searchqueries.md
                  - name: SearchQuery
                    href: web-service-reference/searchquery.md
                  - name: SearchScope
                    href: web-service-reference/searchscope.md
                  - name: SecurityIdentifier
                    href: web-service-reference/securityidentifier.md
                  - name: SeekToConditionPageItemView
                    href: web-service-reference/seektoconditionpageitemview.md
                  - name: Sender
                    href: web-service-reference/sender.md
                  - name: Sender (EmailAddressType)
                    href: web-service-reference/sender-emailaddresstype.md
                  - name: Sender (string)
                    href: web-service-reference/sender-string.md
                  - name: SenderDepartments
                    href: web-service-reference/senderdepartments.md
                  - name: Senders
                    href: web-service-reference/senders.md
                  - name: SenderSmtpAddress
                    href: web-service-reference/sendersmtpaddress.md
                  - name: SendingAs
                    href: web-service-reference/sendingas.md
                  - name: SendItem
                    href: web-service-reference/senditem.md
                  - name: SendItemResponse
                    href: web-service-reference/senditemresponse.md
                  - name: SendItemResponseMessage
                    href: web-service-reference/senditemresponsemessage.md
                  - name: SendNotification
                    href: web-service-reference/sendnotification.md
                  - name: SendNotificationResponseMessage
                    href: web-service-reference/sendnotificationresponsemessage.md
                  - name: SendNotificationResult
                    href: web-service-reference/sendnotificationresult.md
                  - name: SendPrompt
                    href: web-service-reference/sendprompt.md
                  - name: Sensitivity
                    href: web-service-reference/sensitivity.md
                  - name: SendSMSAlertToRecipients
                    href: web-service-reference/sendsmsalerttorecipients.md
                  - name: SentCcMe
                    href: web-service-reference/sentccme.md
                  - name: SentOnlyToMe
                    href: web-service-reference/sentonlytome.md
                  - name: SentTime
                    href: web-service-reference/senttime.md
                  - name: SentToAddresses
                    href: web-service-reference/senttoaddresses.md
                  - name: SentToMe
                    href: web-service-reference/senttome.md
                  - name: SentToOrCcMe
                    href: web-service-reference/senttoorccme.md
                  - name: SerializedSecurityContext
                    href: web-service-reference/serializedsecuritycontext.md
                  - name: Server (MessageTracking)
                    href: web-service-reference/server-messagetracking.md
                  - name: ServerHint
                    href: web-service-reference/serverhint.md
                  - name: ServerReplyWithMessage
                    href: web-service-reference/serverreplywithmessage.md
                  - name: ServerVersionInfo
                    href: web-service-reference/serverversioninfo.md
                  - name: ServiceConfigurationResponseMessageType
                    href: web-service-reference/serviceconfigurationresponsemessagetype.md
                  - name: SetClientExtension
                    href: web-service-reference/setclientextension.md
                  - name: SetClientExtensionResponse
                    href: web-service-reference/setclientextensionresponse.md
                  - name: SetClientExtensionResponseMessage
                    href: web-service-reference/setclientextensionresponsemessage.md
                  - name: SetEncryptionConfiguration
                    href: web-service-reference/setencryptionconfiguration.md
                  - name: SetEncryptionConfigurationResponse
                    href: web-service-reference/setencryptionconfigurationresponse.md
                  - name: SetEncryptionConfigurationResponseMessage
                    href: web-service-reference/setencryptionconfigurationresponsemessage.md
                  - name: SetFolderField
                    href: web-service-reference/setfolderfield.md
                  - name: SetHoldOnMailboxes
                    href: web-service-reference/setholdonmailboxes.md
                  - name: SetHoldOnMailboxesResponse
                    href: web-service-reference/setholdonmailboxesresponse.md
                  - name: SetHoldOnMailboxesResponseMessage
                    href: web-service-reference/setholdonmailboxesresponsemessage.md
                  - name: SetImGroup
                    href: web-service-reference/setimgroup.md
                  - name: SetImGroupResponse
                    href: web-service-reference/setimgroupresponse.md
                  - name: SetImListMigrationCompleted
                    href: web-service-reference/setimlistmigrationcompleted.md
                  - name: SetImListMigrationCompletedResponse
                    href: web-service-reference/setimlistmigrationcompletedresponse.md
                  - name: SetItemField
                    href: web-service-reference/setitemfield.md
                  - name: SetRuleOperation
                    href: web-service-reference/setruleoperation.md
                  - name: SetTeamMailbox
                    href: web-service-reference/setteammailbox.md
                  - name: SetTeamMailboxResponse
                    href: web-service-reference/setteammailboxresponse.md
                  - name: SetUserOofSettingsRequest
                    href: web-service-reference/setuseroofsettingsrequest.md
                  - name: SetUserOofSettingsResponse
                    href: web-service-reference/setuseroofsettingsresponse.md
                  - name: SharedFolderId
                    href: web-service-reference/sharedfolderid.md
                  - name: SharePointSiteUrl
                    href: web-service-reference/sharepointsiteurl.md
                  - name: SharePointUrl (MasterMailboxType)
                    href: web-service-reference/sharepointurl-mastermailboxtype.md
                  - name: SharingEffectiveRights (CalendarPermissionReadAccessType)
                    href: web-service-reference/sharingeffectiverights-calendarpermissionreadaccesstype.md
                  - name: SharingEffectiveRights (PermissionReadAccessType)
                    href: web-service-reference/sharingeffectiverights-permissionreadaccesstype.md
                  - name: SharingFolderId
                    href: web-service-reference/sharingfolderid.md
                  - name: SharingSecurity
                    href: web-service-reference/sharingsecurity.md
                  - name: ShowExternalRecipientCount
                    href: web-service-reference/showexternalrecipientcount.md
                  - name: SID
                    href: web-service-reference/sid.md
                  - name: SIPResponseCode
                    href: web-service-reference/sipresponsecode.md
                  - name: SIPResponseText
                    href: web-service-reference/sipresponsetext.md
                  - name: Size
                    href: web-service-reference/size.md
                  - name: Size (long)
                    href: web-service-reference/size-long.md
                  - name: SizeRequested
                    href: web-service-reference/sizerequested.md
                  - name: SmtpAddress
                    href: web-service-reference/smtpaddress.md
                  - name: SmtpAddress (FederatedDirectoryGroupType)
                    href: web-service-reference/smtpaddress-federateddirectorygrouptype.md
                  - name: SmtpAddress (MasterMailboxType)
                    href: web-service-reference/smtpaddress-mastermailboxtype.md
                  - name: SortBy
                    href: web-service-reference/sortby.md
                  - name: SortOrder
                    href: web-service-reference/sortorder.md
                  - name: SortOrder (ConversationNodeSortOrder)
                    href: web-service-reference/sortorder-conversationnodesortorder.md
                  - name: SortValue
                    href: web-service-reference/sortvalue.md
                  - name: SourceId
                    href: web-service-reference/sourceid.md
                  - name: SourceIds
                    href: web-service-reference/sourceids.md
                  - name: SpecificUsers
                    href: web-service-reference/specificusers.md
                  - name: SpouseName
                    href: web-service-reference/spousename.md
                  - name: SpouseNames
                    href: web-service-reference/spousenames.md
                  - name: Standard
                    href: web-service-reference/standard.md
                  - name: StandardGroupBy
                    href: web-service-reference/standardgroupby.md
                  - name: StandardTime
                    href: web-service-reference/standardtime.md
                  - name: Start
                    href: web-service-reference/start.md
                  - name: StartDate
                    href: web-service-reference/startdate.md
                  - name: StartDate (Recurrence)
                    href: web-service-reference/startdate-recurrence.md
                  - name: StartDateTime
                    href: web-service-reference/startdatetime.md
                  - name: StartFindInGALSpeechRecognition
                    href: web-service-reference/startfindingalspeechrecognition.md
                  - name: StartFindInGALSpeechRecognitionResponse
                    href: web-service-reference/startfindingalspeechrecognitionresponse.md
                  - name: StartTime
                    href: web-service-reference/starttime.md
                  - name: StartTime (ReminderMessageDataType)
                    href: web-service-reference/starttime-remindermessagedatatype.md
                  - name: StartTimeInMinutes
                    href: web-service-reference/starttimeinminutes.md
                  - name: StartTimeZone
                    href: web-service-reference/starttimezone.md
                  - name: StartTimeZoneId
                    href: web-service-reference/starttimezoneid.md
                  - name: StartWallClock
                    href: web-service-reference/startwallclock.md
                  - name: State
                    href: web-service-reference/state-ex15websvcsotherref.md
                  - name: State (TeamMailboxLifecycleStateType)
                    href: web-service-reference/state-teammailboxlifecyclestatetype.md
                  - name: StateDefinition
                    href: web-service-reference/statedefinition.md
                  - name: Status
                    href: web-service-reference/status.md
                  - name: Status (HoldStatusType)
                    href: web-service-reference/status-holdstatustype.md
                  - name: Status (MemberStatusType)
                    href: web-service-reference/status-memberstatustype.md
                  - name: StatusDescription
                    href: web-service-reference/statusdescription.md
                  - name: StatusEvent
                    href: web-service-reference/statusevent.md
                  - name: StatusFrequency
                    href: web-service-reference/statusfrequency.md
                  - name: StopProcessingRules
                    href: web-service-reference/stopprocessingrules.md
                  - name: StorageQuota
                    href: web-service-reference/storagequota.md
                  - name: StoreEntryId
                    href: web-service-reference/storeentryid.md
                  - name: StreamingSubscriptionRequest
                    href: web-service-reference/streamingsubscriptionrequest.md
                  - name: Street
                    href: web-service-reference/street.md
                  - name: String
                    href: web-service-reference/string.md
                  - name: StringArrayAttributedValue
                    href: web-service-reference/stringarrayattributedvalue.md
                  - name: StringAttributedValue
                    href: web-service-reference/stringattributedvalue.md
                  - name: Subject (CalendarEventDetails)
                    href: web-service-reference/subject-calendareventdetails.md
                  - name: Subject
                    href: web-service-reference/subject.md
                  - name: SubmittedTime
                    href: web-service-reference/submittedtime.md
                  - name: SubmitTime
                    href: web-service-reference/submittime.md
                  - name: Subscribe
                    href: web-service-reference/subscribe.md
                  - name: SubscribeResponse
                    href: web-service-reference/subscriberesponse.md
                  - name: SubscribeResponseMessage
                    href: web-service-reference/subscriberesponsemessage.md
                  - name: SubscriptionId (GetEvents)
                    href: web-service-reference/subscriptionid-getevents.md
                  - name: SubscriptionId (GetStreamingEvents)
                    href: web-service-reference/subscriptionid-getstreamingevents.md
                  - name: SubscriptionStatus
                    href: web-service-reference/subscriptionstatus.md
                  - name: Suffix
                    href: web-service-reference/suffix.md
                  - name: Suggestion
                    href: web-service-reference/suggestion.md
                  - name: SuggestionArray
                    href: web-service-reference/suggestionarray.md
                  - name: SuggestionDayResult
                    href: web-service-reference/suggestiondayresult.md
                  - name: SuggestionDayResultArray
                    href: web-service-reference/suggestiondayresultarray.md
                  - name: SuggestionQuality
                    href: web-service-reference/suggestionquality.md
                  - name: SuggestionsResponse
                    href: web-service-reference/suggestionsresponse.md
                  - name: SuggestionsViewOptions
                    href: web-service-reference/suggestionsviewoptions.md
                  - name: SuppressReadReceipt
                    href: web-service-reference/suppressreadreceipt.md
                  - name: SuppressReadReceipts
                    href: web-service-reference/suppressreadreceipts.md
                  - name: Surname
                    href: web-service-reference/surname.md
                  - name: Surnames
                    href: web-service-reference/surnames.md
                  - name: SyncFolderHierarchy
                    href: web-service-reference/syncfolderhierarchy.md
                  - name: SyncFolderHierarchyResponse
                    href: web-service-reference/syncfolderhierarchyresponse.md
                  - name: SyncFolderHierarchyResponseMessage
                    href: web-service-reference/syncfolderhierarchyresponsemessage.md
                  - name: SyncFolderId
                    href: web-service-reference/syncfolderid.md
                  - name: SyncFolderItems
                    href: web-service-reference/syncfolderitems.md
                  - name: SyncFolderItemsResponse
                    href: web-service-reference/syncfolderitemsresponse.md
                  - name: SyncFolderItemsResponseMessage
                    href: web-service-reference/syncfolderitemsresponsemessage.md
                  - name: SyncScope
                    href: web-service-reference/syncscope.md
                  - name: SyncState
                    href: web-service-reference/syncstate-ex15websvcsotherref.md
                  - name: SyncState (base64Binary)
                    href: web-service-reference/syncstate-base64binary.md
                  - name: Task
                    href: web-service-reference/task.md
                  - name: TasksFolder
                    href: web-service-reference/tasksfolder.md
                  - name: TasksFolderPermissionLevel
                    href: web-service-reference/tasksfolderpermissionlevel.md
                  - name: TaskString
                    href: web-service-reference/taskstring.md
                  - name: TaskSuggestion
                    href: web-service-reference/tasksuggestion.md
                  - name: TaskSuggestions
                    href: web-service-reference/tasksuggestions.md
                  - name: TaskTimedOut
                    href: web-service-reference/tasktimedout.md
                  - name: TelexNumbers
                    href: web-service-reference/telexnumbers.md
                  - name: TelUriAddress
                    href: web-service-reference/teluriaddress.md
                  - name: TemplateDescription
                    href: web-service-reference/templatedescription.md
                  - name: TemplateName
                    href: web-service-reference/templatename.md
                  - name: TentativelyAcceptItem
                    href: web-service-reference/tentativelyacceptitem.md
                  - name: Term
                    href: web-service-reference/term.md
                  - name: TextBody
                    href: web-service-reference/textbody.md
                  - name: Time
                    href: web-service-reference/time.md
                  - name: Time (TimeChangeType)
                    href: web-service-reference/time-timechangetype.md
                  - name: TimeOffset
                    href: web-service-reference/timeoffset.md
                  - name: Timeout
                    href: web-service-reference/timeout.md
                  - name: Timeout (duration)
                    href: web-service-reference/timeout-duration.md
                  - name: TimeStamp
                    href: web-service-reference/timestamp.md
                  - name: TimeWindow
                    href: web-service-reference/timewindow.md
                  - name: TimeZone (Availability)
                    href: web-service-reference/timezone-availability.md
                  - name: TimeZone (Item)
                    href: web-service-reference/timezone-item.md
                  - name: TimeZoneContext
                    href: web-service-reference/timezonecontext.md
                  - name: TimeZoneDefinition
                    href: web-service-reference/timezonedefinition.md
                  - name: TimeZoneDefinitions
                    href: web-service-reference/timezonedefinitions.md
                  - name: Title
                    href: web-service-reference/title.md
                  - name: Titles
                    href: web-service-reference/titles.md
                  - name: To
                    href: web-service-reference/to.md
                  - name: ToDate
                    href: web-service-reference/todate.md
                  - name: ToFolderId
                    href: web-service-reference/tofolderid.md
                  - name: Token
                    href: web-service-reference/token.md
                  - name: Token (ClientAccessTokenType)
                    href: web-service-reference/token-clientaccesstokentype.md
                  - name: Token (String)
                    href: web-service-reference/token-string.md
                  - name: TokenRequest
                    href: web-service-reference/tokenrequest.md
                  - name: TokenRequests
                    href: web-service-reference/tokenrequests.md
                  - name: TokenType
                    href: web-service-reference/tokentype.md
                  - name: TokenType (ClientAccessTokenType)
                    href: web-service-reference/tokentype-clientaccesstokentype.md
                  - name: TokenValue
                    href: web-service-reference/tokenvalue.md
                  - name: TooBigGroupAttendeeConflictData
                    href: web-service-reference/toobiggroupattendeeconflictdata.md
                  - name: ToRecipients
                    href: web-service-reference/torecipients.md
                  - name: ToRecipients (ArrayOfSmtpAddressType)
                    href: web-service-reference/torecipients-arrayofsmtpaddresstype.md
                  - name: TotalConversationsInView
                    href: web-service-reference/totalconversationsinview.md
                  - name: TotalCount
                    href: web-service-reference/totalcount.md
                  - name: TotalMemberCount
                    href: web-service-reference/totalmembercount.md
                  - name: TotalNumberOfPeopleInView
                    href: web-service-reference/totalnumberofpeopleinview.md
                  - name: TotalWork
                    href: web-service-reference/totalwork.md
                  - name: TrackingPropertyType
                    href: web-service-reference/trackingpropertytype.md
                  - name: Transition
                    href: web-service-reference/transition.md
                  - name: Transitions
                    href: web-service-reference/transitions.md
                  - name: TransitionsGroup
                    href: web-service-reference/transitionsgroup.md
                  - name: TransitionsGroups
                    href: web-service-reference/transitionsgroups.md
                  - name: "True"
                    href: web-service-reference/true.md
                  - name: TTL
                    href: web-service-reference/ttl.md
                  - name: TTL (ClientAccessTokenTypeType)
                    href: web-service-reference/ttl-clientaccesstokentypetype.md
                  - name: TTYTDDPhoneNumbers
                    href: web-service-reference/ttytddphonenumbers.md
                  - name: Type (ElcFolderType)
                    href: web-service-reference/type-elcfoldertype.md
                  - name: Type (string)
                    href: web-service-reference/type-string.md
                  - name: Type (UserConfiguration)
                    href: web-service-reference/type-userconfiguration.md
                  - name: UID
                    href: web-service-reference/uid.md
                  - name: UID (ReminderType)
                    href: web-service-reference/uid-remindertype.md
                  - name: UmEnabled
                    href: web-service-reference/umenabled.md
                  - name: UnifiedMessagingConfiguration
                    href: web-service-reference/unifiedmessagingconfiguration.md
                  - name: UninstallApp
                    href: web-service-reference/uninstallapp.md
                  - name: UninstallAppResponse
                    href: web-service-reference/uninstallappresponse.md
                  - name: UniqueBody
                    href: web-service-reference/uniquebody.md
                  - name: UniqueBodyType
                    href: web-service-reference/uniquebodytype.md
                  - name: UniqueHash
                    href: web-service-reference/uniquehash.md
                  - name: UniquePathId
                    href: web-service-reference/uniquepathid.md
                  - name: UniqueRecipients
                    href: web-service-reference/uniquerecipients.md
                  - name: UniqueSenders
                    href: web-service-reference/uniquesenders.md
                  - name: UniqueUnreadSenders
                    href: web-service-reference/uniqueunreadsenders.md
                  - name: UnknownAttendeeConflictData
                    href: web-service-reference/unknownattendeeconflictdata.md
                  - name: UnknownEntries
                    href: web-service-reference/unknownentries.md
                  - name: UnknownEntry
                    href: web-service-reference/unknownentry.md
                  - name: UnpinTeamMailbox
                    href: web-service-reference/unpinteammailbox.md
                  - name: UnpinTeamMailboxResponse
                    href: web-service-reference/unpinteammailboxresponse.md
                  - name: UnreadCount
                    href: web-service-reference/unreadcount.md
                  - name: UnresolvedEntry
                    href: web-service-reference/unresolvedentry.md
                  - name: Unsubscribe
                    href: web-service-reference/unsubscribe.md
                  - name: UnsubscribeResponse
                    href: web-service-reference/unsubscriberesponse.md
                  - name: UnsubscribeResponseMessage
                    href: web-service-reference/unsubscriberesponsemessage.md
                  - name: Update (FolderSync)
                    href: web-service-reference/update-foldersync.md
                  - name: Update (ItemSync)
                    href: web-service-reference/update-itemsync.md
                  - name: UpdateDelegate
                    href: web-service-reference/updatedelegate.md
                  - name: UpdateDelegateResponse
                    href: web-service-reference/updatedelegateresponse.md
                  - name: UpdatedItemIds
                    href: web-service-reference/updateditemids.md
                  - name: UpdateFolder
                    href: web-service-reference/updatefolder.md
                  - name: UpdateFolderResponse
                    href: web-service-reference/updatefolderresponse.md
                  - name: UpdateFolderResponseMessage
                    href: web-service-reference/updatefolderresponsemessage.md
                  - name: UpdateInboxRules
                    href: web-service-reference/updateinboxrules.md
                  - name: UpdateInboxRulesResponse
                    href: web-service-reference/updateinboxrulesresponse.md
                  - name: UpdateItem
                    href: web-service-reference/updateitem.md
                  - name: UpdateItemInRecoverableItems
                    href: web-service-reference/updateiteminrecoverableitems.md
                  - name: UpdateItemInRecoverableItemsResponse
                    href: web-service-reference/updateiteminrecoverableitemsresponse.md
                  - name: UpdateItemInRecoverableItemsResponseMessage
                    href: web-service-reference/updateiteminrecoverableitemsresponsemessage.md
                  - name: UpdateItemResponse
                    href: web-service-reference/updateitemresponse.md
                  - name: UpdateItemResponseMessage
                    href: web-service-reference/updateitemresponsemessage.md
                  - name: UpdateMailboxAssociation
                    href: web-service-reference/updatemailboxassociation.md
                  - name: UpdateMailboxAssociationResponse
                    href: web-service-reference/updatemailboxassociationresponse.md
                  - name: UpdateMailboxAssociationResponseMessage
                    href: web-service-reference/updatemailboxassociationresponsemessage.md
                  - name: Updates (Folder)
                    href: web-service-reference/updates-folder.md
                  - name: Updates (Item)
                    href: web-service-reference/updates-item.md
                  - name: UpdateUserConfiguration
                    href: web-service-reference/updateuserconfiguration.md
                  - name: UpdateUserConfigurationResponse
                    href: web-service-reference/updateuserconfigurationresponse.md
                  - name: UpdateUserConfigurationResponseMessage
                    href: web-service-reference/updateuserconfigurationresponsemessage.md
                  - name: UploadItems
                    href: web-service-reference/uploaditems.md
                  - name: UploadItemsResponse
                    href: web-service-reference/uploaditemsresponse.md
                  - name: UploadItemsResponseMessage
                    href: web-service-reference/uploaditemsresponsemessage.md
                  - name: 'Url '
                    href: web-service-reference/url-ex15websvcsotherref.md
                  - name: UrlEntity
                    href: web-service-reference/urlentity.md
                  - name: Urls
                    href: web-service-reference/urls.md
                  - name: Urls (ArrayOfUrlEntitiesType)
                    href: web-service-reference/urls-arrayofurlentitiestype.md
                  - name: User (MailboxAssociationType)
                    href: web-service-reference/user-mailboxassociationtype.md
                  - name: UserConfiguration
                    href: web-service-reference/userconfiguration.md
                  - name: UserConfigurationName
                    href: web-service-reference/userconfigurationname.md
                  - name: UserConfigurationProperties
                    href: web-service-reference/userconfigurationproperties.md
                  - name: UserDisabledExtensions
                    href: web-service-reference/userdisabledextensions.md
                  - name: UserEnabledExtensions
                    href: web-service-reference/userenabledextensions.md
                  - name: UserId
                    href: web-service-reference/userid.md
                  - name: UserId (string)
                    href: web-service-reference/userid-string.md
                  - name: UserIds
                    href: web-service-reference/userids.md
                  - name: UserMailbox
                    href: web-service-reference/usermailbox.md
                  - name: UserOofSettings
                    href: web-service-reference/useroofsettings.md
                  - name: UserOptions
                    href: web-service-reference/useroptions.md
                  - name: UserParameters
                    href: web-service-reference/userparameters.md
                  - name: UserRoles
                    href: web-service-reference/userroles.md
                  - name: UserSid
                    href: web-service-reference/usersid.md
                  - name: UserSMIMECertificate
                    href: web-service-reference/usersmimecertificate.md
                  - name: ValidationErrors
                    href: web-service-reference/validationerrors.md
                  - name: Value
                    href: web-service-reference/value.md
                  - name: Value (ArrayOfStringValueType)
                    href: web-service-reference/value-arrayofstringvaluetype.md
                  - name: Value (BodyContentType)
                    href: web-service-reference/value-bodycontenttype.md
                  - name: Value (EmailAddressType)
                    href: web-service-reference/value-emailaddresstype.md
                  - name: Value (ExtendedAttributeType)
                    href: web-service-reference/value-extendedattributetype.md
                  - name: Value (ExtendedPropertyType)
                    href: web-service-reference/value-extendedpropertytype.md
                  - name: Value (Message Tracking)
                    href: web-service-reference/value-message-tracking.md
                  - name: Value (PersonaPhoneNumberType)
                    href: web-service-reference/value-personaphonenumbertype.md
                  - name: Value (PersonaPostalAddressType)
                    href: web-service-reference/value-personapostaladdresstype.md
                  - name: Value (ProtectionRuleValueType)
                    href: web-service-reference/value-protectionrulevaluetype.md
                  - name: Value (UserConfiguration)
                    href: web-service-reference/value-userconfiguration.md
                  - name: Values
                    href: web-service-reference/values.md
                  - name: Values (ArrayOfStringValueType)
                    href: web-service-reference/values-arrayofstringvaluetype.md
                  - name: ViewPrivateItems
                    href: web-service-reference/viewprivateitems.md
                  - name: VotingInformation
                    href: web-service-reference/votinginformation.md
                  - name: VotingOptionData
                    href: web-service-reference/votingoptiondata.md
                  - name: VotingResponse
                    href: web-service-reference/votingresponse.md
                  - name: Watermark
                    href: web-service-reference/watermark.md
                  - name: WebClientEditFormQueryString
                    href: web-service-reference/webclienteditformquerystring.md
                  - name: WebClientReadFormQueryString
                    href: web-service-reference/webclientreadformquerystring.md
                  - name: WeddingAnniversaries
                    href: web-service-reference/weddinganniversaries.md
                  - name: WeddingAnniversary
                    href: web-service-reference/weddinganniversary.md
                  - name: WeeklyRecurrence
                    href: web-service-reference/weeklyrecurrence.md
                  - name: WeeklyRegeneration
                    href: web-service-reference/weeklyregeneration.md
                  - name: When
                    href: web-service-reference/when.md
                  - name: WithinDateRange
                    href: web-service-reference/withindaterange.md
                  - name: WithinSizeRange
                    href: web-service-reference/withinsizerange.md
                  - name: WorkCity
                    href: web-service-reference/workcity.md
                  - name: WorkCitySortKey
                    href: web-service-reference/workcitysortkey.md
                  - name: WorkFaxes
                    href: web-service-reference/workfaxes.md
                  - name: WorkingHours
                    href: web-service-reference/workinghours-ex15websvcsotherref.md
                  - name: WorkingPeriod
                    href: web-service-reference/workingperiod.md
                  - name: WorkingPeriodArray
                    href: web-service-reference/workingperiodarray.md
                  - name: WouldRepair
                    href: web-service-reference/wouldrepair.md
                  - name: XmlData
                    href: web-service-reference/xmldata.md
                  - name: Year
                    href: web-service-reference/year.md
                  - name: YearlyRegeneration
                    href: web-service-reference/yearlyregeneration.md
                  - name: YomiCompanyName
                    href: web-service-reference/yomicompanyname.md
                  - name: YomiCompanyNames
                    href: web-service-reference/yomicompanynames.md
                  - name: YomiFirstName
                    href: web-service-reference/yomifirstname.md
                  - name: YomiFirstNames
                    href: web-service-reference/yomifirstnames.md
                  - name: YomiLastName
                    href: web-service-reference/yomilastname.md
                  - name: YomiLastNames
                    href: web-service-reference/yomilastnames.md
        ...
        - name: Backup and restore
          ...
          - name: Backup and restore concepts
            ...
            - name: Transaction logs and checkpoint files
              href: backup-restore/transaction-logs-and-checkpoint-files-for-backup-and-restore-in-exchange.md
          ...
          - name: Build backup and restore applications
            ...
            - name: Restore Exchange 2013 databases
              href: backup-restore/restoring-exchange-2013-databases.md
            - name: Validate backup integrity by using the CHKSGFILES API
              href: backup-restore/how-to-validate-backup-integrity-by-using-the-chksgfiles-api-in-exchange.md
            - name: Validate backup integrity by using the Eseutil tool
